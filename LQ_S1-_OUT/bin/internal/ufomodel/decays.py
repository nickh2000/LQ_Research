...
Decay_b = Decay(name = 'Decay_b',
                particle = P.b,
                partial_widths = {(P.S1tm43,P.e__plus__):'((MB**2 - MS1t**2)*(3*MB**2*yRR3x1**2 - 3*MS1t**2*yRR3x1**2))/(96.*cmath.pi*abs(MB)**3)',
                                  (P.S1tm43,P.mu__plus__):'((MB**2 - MS1t**2)*(3*MB**2*yRR3x2**2 - 3*MS1t**2*yRR3x2**2))/(96.*cmath.pi*abs(MB)**3)',
                                  (P.S1tm43,P.ta__plus__):'((3*MB**2*yRR3x3**2 - 3*MS1t**2*yRR3x3**2 + 3*MTA**2*yRR3x3**2)*cmath.sqrt(MB**4 - 2*MB**2*MS1t**2 + MS1t**4 - 2*MB**2*MTA**2 - 2*MS1t**2*MTA**2 + MTA**4))/(96.*cmath.pi*abs(MB)**3)',
...
Decay_S1tm43 = Decay(name = 'Decay_S1tm43',
                     particle = P.S1tm43,
                     partial_widths = {(P.b,P.e__minus__):'((-MB**2 + MS1t**2)*(-3*MB**2*yRR3x1**2 + 3*MS1t**2*yRR3x1**2))/(48.*cmath.pi*abs(MS1t)**3)',
                                       (P.b,P.mu__minus__):'((-MB**2 + MS1t**2)*(-3*MB**2*yRR3x2**2 + 3*MS1t**2*yRR3x2**2))/(48.*cmath.pi*abs(MS1t)**3)',
                                       (P.b,P.ta__minus__):'((-3*MB**2*yRR3x3**2 + 3*MS1t**2*yRR3x3**2 - 3*MTA**2*yRR3x3**2)*cmath.sqrt(MB**4 - 2*MB**2*MS1t**2 + MS1t**4 - 2*MB**2*MTA**2 - 2*MS1t**2*MTA**2 + MTA**4))/(48.*cmath.pi*abs(MS1t)**3)',
                                       (P.d,P.e__minus__):'(MS1t**4*yRR1x1**2)/(16.*cmath.pi*abs(MS1t)**3)',
                                       (P.d,P.mu__minus__):'(MS1t**4*yRR1x2**2)/(16.*cmath.pi*abs(MS1t)**3)',
                                       (P.d,P.ta__minus__):'((MS1t**2 - MTA**2)*(3*MS1t**2*yRR1x3**2 - 3*MTA**2*yRR1x3**2))/(48.*cmath.pi*abs(MS1t)**3)',
                                       (P.e__minus__,P.s):'(MS1t**4*yRR2x1**2)/(16.*cmath.pi*abs(MS1t)**3)',
                                       (P.mu__minus__,P.s):'(MS1t**4*yRR2x2**2)/(16.*cmath.pi*abs(MS1t)**3)',
                                       (P.s,P.ta__minus__):'((MS1t**2 - MTA**2)*(3*MS1t**2*yRR2x3**2 - 3*MTA**2*yRR2x3**2))/(48.*cmath.pi*abs(MS1t)**3)'})
...
Decay_ta__minus__ = Decay(name = 'Decay_ta__minus__',
                          ...
                          partial_widths = {(P.S1tm43,P.b__tilde__):'((3*MB**2*yRR3x3**2 - 3*MS1t**2*yRR3x3**2 + 3*MTA**2*yRR3x3**2)*cmath.sqrt(MB**4 - 2*MB**2*MS1t**2 + MS1t**4 - 2*MB**2*MTA**2 - 2*MS1t**2*MTA**2 + MTA**4))/(32.*cmath.pi*abs(MTA)**3)',
                                            (P.S1tm43,P.d__tilde__):'((-MS1t**2 + MTA**2)*(-3*MS1t**2*yRR1x3**2 + 3*MTA**2*yRR1x3**2))/(32.*cmath.pi*abs(MTA)**3)',
                                            (P.S1tm43,P.s__tilde__):'((-MS1t**2 + MTA**2)*(-3*MS1t**2*yRR2x3**2 + 3*MTA**2*yRR2x3**2))/(32.*cmath.pi*abs(MTA)**3)',
