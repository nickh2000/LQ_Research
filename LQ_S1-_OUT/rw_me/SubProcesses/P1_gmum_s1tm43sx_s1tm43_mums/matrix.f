...
C     ----------
      ...
      CALL FFS3C1_3(W(1,4),W(1,3),GC_68,MDL_MS1T,MDL_WS1T,W(1,5))
      CALL OXXXXX(P(0,5),ZERO,NHEL(5),+1*IC(5),W(1,4))
      CALL VSS1_2(W(1,1),W(1,5),GC_11,MDL_MS1T,MDL_WS1T,W(1,3))
C     Amplitude(s) for diagram number 1
      CALL FFS5C1_0(W(1,2),W(1,4),W(1,3),GC_68,AMP(1))
      CALL FFV1C1_1(W(1,4),W(1,1),GC_12,ZERO,ZERO,W(1,3))
