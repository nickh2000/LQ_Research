...
C     
C     Process: g mu- > s1tm43 s~ WEIGHTED<=3 @1
...
C     ----------
     ...
     $    ABS(mdl_MS1t*small_width_treatment)), mdl_WS1t)
      ...
      AMP(:,:) = (0d0,0d0)
            CALL VXXXXX(P(0,1),ZERO,+1,-1*IC(1),W(1,1)) ! count 2
      CALL VXXXXX(P(0,1),ZERO,-1,-1*IC(1),W(1,2)) ! count 2
      ...
      CALL FFS3C1_3(W(1,4),W(1,5),GC_65,MDL_MS1T, FK_MDL_WS1T,W(1,6)) ! count 4
      CALL OXXXXX(P(0,5),ZERO,-1,+1*IC(5),W(1,7)) ! count 4
      CALL VSS1_2(W(1,1),W(1,6),GC_11,MDL_MS1T, ZERO,W(1,8)) ! count 1
      CALL VSS1_2(W(1,2),W(1,6),GC_11,MDL_MS1T, ZERO,W(1,9)) ! count 1
      CALL FFS5C1P1N_3(W(1,3), W(1,7), GC_68, TMP(1))
      call CombineAmpS(2, 
     &(/2,1/), 
     & (/8,9/), 
     & TMP, W, AMP(1,1)) ! count 1
      CALL FFV1C1_1(W(1,7),W(1,1),GC_12,ZERO, FK_ZERO,W(1,10)) ! count 1
      CALL FFV1C1_1(W(1,7),W(1,2),GC_12,ZERO, FK_ZERO,W(1,11)) ! count 1
      CALL FFS5C1P1N_2(W(1,3), W(1,6), GC_68, TMP(1))
      call CombineAmp(2,
     & (/2,1/), 
     & (/10,11/),
