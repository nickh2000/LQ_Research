...
C     
C     Process: s mu- > s1tm43 g WEIGHTED<=3 @1
...
C     ----------
     ...
     $    ABS(mdl_MS1t*small_width_treatment)), mdl_WS1t)
      ...
      CALL FFS5C1P1N_3(W(1,2), W(1,1), GC_68, TMP(1))
      call CombineAmpS(2, 
     &(/2,1/), 
     & (/8,9/), 
     & TMP, W, AMP(1,1)) ! count 1
      CALL FFV1C1_1(W(1,1),W(1,6),GC_12,ZERO, FK_ZERO,W(1,10)) ! count 1
      CALL FFV1C1_1(W(1,1),W(1,7),GC_12,ZERO, FK_ZERO,W(1,11)) ! count 1
      CALL FFS5C1P1N_2(W(1,2), W(1,5), GC_68, TMP(1))
      call CombineAmp(2,
     & (/2,1/), 
     & (/10,11/),
