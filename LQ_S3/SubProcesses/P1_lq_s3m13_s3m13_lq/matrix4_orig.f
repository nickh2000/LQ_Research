...
C     ----------
     ...
     $   *SMALL_WIDTH_TREATMENT)), ZERO)
        IF(MDL_WS313.NE.0D0) FK_MDL_WS313 = SIGN(MAX(ABS(MDL_WS313),
     $    ABS(MDL_MS3*SMALL_WIDTH_TREATMENT)), MDL_WS313)
      ...
      CALL FFS4C1_3(W(1,3),W(1,4),GC_112,MDL_MS3, FK_MDL_WS313,W(1,5))
C     Amplitude(s) for diagram number 1
      CALL FFS3C1_0(W(1,2),W(1,1),W(1,5),GC_112,AMP(1))
