...
C     
C     Process: mu- u > s3m13 WEIGHTED<=2 @1
C     *   Decay: s3m13 > mu- u WEIGHTED<=2
C     Process: mu- u > s3m13 WEIGHTED<=2 @1
C     *   Decay: s3m13 > mu- c WEIGHTED<=2
C     Process: mu- c > s3m13 WEIGHTED<=2 @1
C     *   Decay: s3m13 > mu- u WEIGHTED<=2
C     Process: mu- c > s3m13 WEIGHTED<=2 @1
C     *   Decay: s3m13 > mu- c WEIGHTED<=2
C     
...
C       Flip CM_RAP (to get rapidity right)
      ...
      IF (PASSCUTS(P1)) THEN
        ...
        ENDIF
        IF(IPROC.EQ.1) DSIGPROC=DSIG1(P1,WGT,IMODE)  ! mu- u > mu- u
        IF(IPROC.EQ.2) DSIGPROC=DSIG2(P1,WGT,IMODE)  ! mu- u > mu- c
        IF(IPROC.EQ.3) DSIGPROC=DSIG3(P1,WGT,IMODE)  ! mu- c > mu- u
        IF(IPROC.EQ.4) DSIGPROC=DSIG4(P1,WGT,IMODE)  ! mu- c > mu- c
      ENDIF
